...
function TweetInteractions({
  ...
  return (
    <>
      <div
        className={`h-fit text-twitterTextAlt w-full flex flex-wrap items-center border-twitterBorder py-3 align-middle gap-2 sm:gap-4 ${
          showPadding
            ? "justify-between sm:justify-around border-y my-4"
            : "justify-between"
        }`}
      >
        <InteractionButton
